...
-   Die Wohnfläche beträgt durchschnittlich 2.080 Quadraftfuß, was in ca. 193 Quadratmeter ist.

-   Die Median Größe eines Grundstücks beträgt 7.618 Quadratfuß, wobei das größte Gründstücl 1.651.359 Quadratfuß hat.

-   Die Häuser in unserem Datensatz haben außerdem durchscnittlich 3.4 Zimmer und 2.25 Badezimmer.
...
### 1. Zustand der Häuser nach Baujahr
...
### 2. Durschnittlicher Preis der Häuser nach Baujahr
...
### 3. Preis der Häuser nach Wohnfläche und Zustand
...
### 4. Verteilung der Preise nach Anzahl der Stockwerke
...
### 5. Verteilung der Preise nach Anzahl der Zimmer
...
ggplot(data = world) +
    geom_sf() +
    geom_point(data = data, aes(x = long, y = lat, color=as.factor(pricecat)), size = 0.5, 
...
### 7. Korrelation der einzelnen Merkmale mit Preis
